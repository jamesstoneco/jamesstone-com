  ...
  blog.articles[0..9].each do |article|
    xml.entry do
      ...
      unless article.data.featured_image.nil?
        xml.summary "#{tag(:img, :src => "https://www.jamesstone.com#{asset_url(article.data.featured_image)}")} #{article.summary.sub( %r{href="/blog/}, 'href="http://www.manofstone.com/blog/' )}", "type" => "html"
        ...
        xml.summary article.summary.sub( %r{href="/blog/}, 'href="https://www.jamesstone.com/blog/' ), "type" => "html"
