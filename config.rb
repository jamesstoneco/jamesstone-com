...
set :sass_assets_paths, [File.join(root, 'bower_components/foundation-sites-6/scss'), File.join(root, 'bower_components/motion-ui'), File.join(root, 'bower_components/slick-carousel/slick')]
